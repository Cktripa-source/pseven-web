...
import { User, AtSign, FileText, Phone, MapPin, Clock, Briefcase, ArrowRight } from 'lucide-react';
...
const JobEmployers = () => {
  ...
  // Check URL for job ID parameter
  useEffect(() => {
  ...
  // If we're viewing a specific job
  if (viewingJobId) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16 px-6 pt-20 mt-20">
        ...
        {isFormOpen && renderApplicationModal()}
      </div>
    );
  }

  // Helper function to keep the main return cleaner
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {job.employmentType && (
                    <div className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm inline-block">
                      {job.employmentType}
                    </div>
                  )}
                </div>
